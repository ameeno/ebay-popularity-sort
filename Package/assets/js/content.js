...
if (
  window.location.host.startsWith("www.ebay") &&
  ...
  $(document).ready(function () {
    ...
    chrome.storage.sync.get(
      ...
      function (options) {
        ...
        $("ul.srp-results li.s-item, ul#ListViewInner li[listingid]").each(
          function () {
            ...
            var hotnessText = listing
              .find(
                ".s-item__itemHotness, .hotness-signal, .s-item__authorized-seller"
              )
              .text()
              .replace(/,/g, "");
        ...
        ul.append(
          "<p>These search results have been modified by <b>eBay™ Popularity Sort for Firefox</b>.</p>"
        );
